...
function get_umas_function_name(code)
    ...
    elseif code == 32 then code_name = "0x21 - WRITE_MEMORY_BLOCK: Writes a chunk of binary data to an offset within a certain block ID"
    ...
    elseif code == 40 then code_name = "0x28 - DOWN_LOAD: Read a control logic in current PLC memory"
    elseif code == 41 then code_name = "0x29 - UP_LOAD: Transfer a newly crafted or modified control logic to PLC"
